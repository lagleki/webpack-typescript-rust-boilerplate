...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c39 = /^[p]/;
  const peg$c40 = peg$classExpectation(["p"], false, false);
  const peg$c41 = /^[f]/;
  const peg$c42 = peg$classExpectation(["f"], false, false);
  const peg$c43 = /^[b]/;
  const peg$c44 = peg$classExpectation(["b"], false, false);
  const peg$c45 = /^[g]/;
  const peg$c46 = peg$classExpectation(["g"], false, false);
  const peg$c47 = /^[v]/;
  const peg$c48 = peg$classExpectation(["v"], false, false);
  const peg$c49 = /^[k]/;
  const peg$c50 = peg$classExpectation(["k"], false, false);
  const peg$c51 = /^[x]/;
  const peg$c52 = peg$classExpectation(["x"], false, false);
  const peg$c53 = /^[d]/;
  const peg$c54 = peg$classExpectation(["d"], false, false);
  const peg$c55 = /^[j]/;
  const peg$c56 = peg$classExpectation(["j"], false, false);
  const peg$c57 = /^[z]/;
  const peg$c58 = peg$classExpectation(["z"], false, false);
  const peg$c59 = /^[c]/;
  const peg$c60 = peg$classExpectation(["c"], false, false);
  const peg$c61 = /^[s]/;
  const peg$c62 = peg$classExpectation(["s"], false, false);
  const peg$c63 = /^[t]/;
  const peg$c64 = peg$classExpectation(["t"], false, false);
  const peg$c65 = /^[']/;
  ...
  const peg$c72 = /^[^a-za-z,']/;
  const peg$c73 = peg$classExpectation([["a", "z"], ["a", "z"], ",", "'"], true, false);
  const peg$c74 = function(expr: any): any {return ["drata", _join(expr)];};
  const peg$c75 = /^[^ ]/;
  const peg$c76 = peg$classExpectation([" "], true, false);
  ...
  function peg$parsesibilant(): any {
    let s0, s1, s2, s3, s4;
