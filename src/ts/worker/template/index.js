...
function setStateFromUrl({ href }) {
  ...
  if (['selmaho'].includes(params.versio)) {
    ...
    children: h('div', {
      ...
      children: [
        h('span', {
          class: 'SPAN_3',
          style: { width: 'auto' },
          children: h('b', { class: 'B_4', innerHTML: title }),
        }),
        h('a', {
...
function PollyPlayer(params) {
  ...
  function downloadAudio(Text, dontSpeak, queryLanguage) {
    return new Promise(function (resolve, reject) {
      fetch(
        `https://github.com/La-Lojban/sutysisku/raw/asql/sance/vreji/${encodeURIComponent(
          Text
        )}.mp3`
      )
        .then((res) => {
